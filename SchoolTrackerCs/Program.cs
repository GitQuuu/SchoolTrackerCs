    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (studentLoopState)
            {
                ...
                {
                    FirstName = Utility.ExcludeSymbols("Student name", digits),
                    LastName = Utility.ExcludeSymbols("Student lastname", digits),
                    Grade = Utility.AskInt("Student grade"),
                    CPR = Utility.CPR("Student CPR - dd/mm/year/serial number"),
                    Address = Utility.Ask("Student address"),
                    PhoneNumber = Utility.AskInt("Student phone number"),
                    Email = Utility.ValidateEmail("Student email")
                };
